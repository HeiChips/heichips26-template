...
# Author: Simon Dorrer
# Description: Transient plots for the heichips26_digital_project macro based on ngspice exports.
# ============================================
...
def main():
    ...
    # ------------------------------------------------------------------
    ngspice_file = data_dir / "heichips26_digital_project_tb_tran.txt"
    ...
    fig1.suptitle('HeiChips26 Digital Project - Gate-Level Transient Simulation')
    ...
    # ------------------------------------------------------------------
    fig1.savefig(str(figures_dir / "heichips26_digital_project_tb_tran.svg"), bbox_inches='tight')
    fig1.savefig(str(figures_dir / "heichips26_digital_project_tb_tran.pdf"), bbox_inches='tight')
    np.savetxt(
        str(figures_dir / "heichips26_digital_project_tb_tran.csv"),
        np.column_stack((
